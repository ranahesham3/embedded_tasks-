		...
		* Copy_pu8KeyValue =NOT_PRESSED;
		static u8 Local_Au8KPDArr[ROWS_NUM][COLS_NUM]=KEYS_VALUES;
		 ...
		 for(Local_u8ColIdx=0 ; Local_u8ColIdx <COLS_NUM ; Local_u8ColIdx ++)
		 {
			 ...
			 Local_enuErrorState = DIO_enuSetPinValue(Local_Au8ColPorts [Local_u8ColIdx] , Local_Au8ColPins [Local_u8ColIdx] , DIO_u8HIGH);
		 }
	}
	else
	{
...
u8 Keypad_enuGetPressedKey()
{
	ES_t Local_enuErrorState =ES_NOK;
		...
		static u8 Local_Au8KPDArr[ROWS_NUM][COLS_NUM]=KEYS_VALUES;
		u8 Local_u8RowIdx=0,Local_u8ColIdx=0,Local_u8Pinval;
